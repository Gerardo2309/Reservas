<x-app-layout>
    ...
    <div class="grid mb-4 px-5 rounded-3xl">
        ...
        <div class="grid grid-cols-12 gap-6">
            <div class="grid grid-cols-12 col-span-12 gap-6 xxl:col-span-9">
                            ...
                            <div class="p-5">
                                ...
                                <div class="ml-2 w-full flex-1">
                                    <div>
                                        ...
                                        <div class="mt-1 text-base text-gray-600">Tours</div>
                                    </div>
                                </div>
                            </div>
                        </a>
                            ...
                            <div class="p-5">
                                ...
                                <div class="ml-2 w-full flex-1">
                                    <div>
                                        ...
                                        <div class="mt-1 text-base text-gray-600">Pax Q</div>
                                    </div>
                                </div>
                            </div>
                        </a>
                            ...
                            <div class="p-5">
                                ...
                                <div class="ml-2 w-full flex-1">
                                    <div>
                                        ...
                                        <div class="mt-1 text-base text-gray-600">Pax NQ</div>
                                    </div>
                                </div>
                            </div>
                        </a>
                ...
                <div class="col-span-12 mt-5 pb-8">
